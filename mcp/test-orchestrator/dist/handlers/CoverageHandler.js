 ...
 */
function getRawUncoveredLines(coverageDir, filePath) {
 ...
 */
function findContext(lines, targetLineIndex) {
 ...
 */
export function parseCoverageGaps(coverageDir, projectRoot, threshold = 80, filterFile) {
    const gaps = [];
    const allGapFiles = [];
 ...
 */
export function getCoverageGaps(projectRoot) {
