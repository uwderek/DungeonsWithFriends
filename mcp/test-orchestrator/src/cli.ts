...
const TOOLS = ['run_lint', 'run_unit_tests', 'run_e2e_tests', 'run_tests', 'get_coverage_gaps'] as const;
...
function runTool(toolName: ToolName, options: CLIOptions): TestResult {
